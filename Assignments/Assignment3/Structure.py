...
class struct(object):
    ...
    def solveArc(self, s_lim=inf, load=inf, nodeDis=array([]), reset=True, la=0.1, alfa=0, data=False):
        '''
        ...
        if data:
            return u_hist, la_hist, s_hist, R_hist
        else:
...
def main():
    ...
    p2.addNode(1, array([0, 0, 0]), array([-5.5, 5.  , 0.]))
    p2.addNode(2, array([0, 0, 0]), array([ 4.0, 5.  , 0.]))
    p2.addNode(3, array([0, 0, 0]), array([-5.5, 0.  , 0.]))
    p2.addNode(4, array([0, 0, 0]), array([ 4.0, 0.  , 0.]))
    p2.addNode(5, array([1, 1, 1]), array([0.0, 3.75, 0.5]))
    p2.addNode(6, array([1, 1, 1]), array([0.0, 1.25, 0.5]))
